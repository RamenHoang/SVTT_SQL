...
$(document).ready(function() {
    ...
    function submitDanhGia(email, nhomhuongdan_id) {
        ...
        let gopy = $('#gopy').val().replace(/[\r\n]+/g, '<br/>');

        if (cau_1 == undefined || cau_2 == undefined || cau_3 == undefined || cau_4== undefined){
            Toast.fire({
                icon: "error",
            ...
            $.ajax({
                ...
                success: function(){
                    ...
                    $('<center><p>Bạn đã gửi đánh giá</p></center>').replaceAll($('#review_form'));
                },
                error: function() {
                    Toast.fire({
                        icon: "error",
